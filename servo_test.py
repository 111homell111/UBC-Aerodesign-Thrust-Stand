...
#port = '/dev/cu.usbmodem11301' #port u can find on bottom right of arduino screen
port = '/dev/cu.usbserial-1130' #port u can find on bottom right of arduino screen
baud_rate = 9600 #idk it just has to match on arduino code (this or 9600)
...
window.bind("<Left>", lambda e: slider_x.set(slider_x.get()-20))
window.bind("<Right>", lambda e: slider_x.set(slider_x.get()+20))
